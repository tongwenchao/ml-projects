...
- 平台分工：
  ...
  - 预计总费用：$45–70
- 项目 D：本地 LLM 推理引擎（Week 19–21）🔄 进行中
...
python pipeline.py      # 定时 pipeline
...
**当前进度**：Phase 2 项目 D，Week 19，尚未开始。
...
**当前项目 D 定位**：
- 在本地 M2 跑通 LLM 推理，理解量化实际效果
- Week 19：llama.cpp 安装 + Mistral-7B / Llama-3.2-3B INT4 推理测速
- Week 20：Apple MLX 框架对比
- Week 21：few-shot prompting + CLI 工具封装
...
完整学习进度文档见附件 `ml_learning_progress_v11.md`。
